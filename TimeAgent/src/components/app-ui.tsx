...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, lineHeight: 31, color: color.navy, fontWeight: '900', letterSpacing: -0.55 },
  card: { borderRadius: radius.lg, backgroundColor: color.surface, borderWidth: 1, borderColor: color.border, padding: space.xl, boxShadow: '0 8px 24px rgba(15,23,42,0.045)', elevation: 1 },
  ...
  pill_info: { backgroundColor: '#E7F0FF' },
