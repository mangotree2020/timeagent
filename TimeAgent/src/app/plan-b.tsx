...
const styles = StyleSheet.create({
  bannerTitle: { fontSize: 18, lineHeight: 25, fontWeight: '900', color: color.surface }, bannerBody: { ...type.bodyMuted, color: color.ice, marginTop: 5 }, filters: { flexDirection: 'row', gap: space.sm }, filter: { flex: 1, minHeight: 44, paddingHorizontal: space.sm, borderRadius: radius.pill, backgroundColor: color.surface, borderWidth: 1, borderColor: color.border, alignItems: 'center', justifyContent: 'center' }, filterActive: { backgroundColor: color.deepBlue, borderColor: color.deepBlue }, filterText: { fontSize: 12, color: color.textMuted, fontWeight: '700', textAlign: 'center' }, filterTextActive: { color: color.surface }, sortDescription: { ...type.caption, marginTop: -space.md }, option: { gap: space.md }, optionSelected: { borderWidth: 2, borderColor: color.cyan }, pills: { flexDirection: 'row', flexWrap: 'wrap', gap: space.sm }, optionTop: { flexDirection: 'row', alignItems: 'center', gap: space.md }, optionIcon: { width: 48, height: 48, borderRadius: 24, alignItems: 'center', justifyContent: 'center', backgroundColor: color.surfaceMuted }, optionArrival: { fontSize: 22, color: color.navy, fontWeight: '900' }, optionStatus: { fontSize: 12, color: color.success, fontWeight: '800', marginTop: 2 }, routeMetrics: { flexDirection: 'row', gap: space.sm }, routeMetric: { color: color.deepBlue, fontSize: 14, fontWeight: '900' }, tags: { flexDirection: 'row', gap: 6, flexWrap: 'wrap' }, tag: { paddingVertical: 5, paddingHorizontal: 9, borderRadius: radius.pill, backgroundColor: color.surfaceMuted, color: color.textMuted, fontSize: 11, fontWeight: '700' }, evidence: { ...type.caption }, liveRouteStatus: { minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: space.sm, paddingHorizontal: space.md }, liveRouteText: { ...type.caption, flexShrink: 1, textAlign: 'center' }, confirmation: { gap: space.md, borderWidth: 2, borderColor: color.cyan }, confirmationHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: space.sm }, changeRow: { minHeight: 42, flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: color.border }, changeLabel: { width: 84, color: color.textMuted, fontSize: 13, fontWeight: '700' }, changeBefore: { flex: 1, textAlign: 'right', color: color.textMuted, fontSize: 14, textDecorationLine: 'line-through' }, changeAfter: { flex: 1, textAlign: 'right', color: color.deepBlue, fontSize: 14, fontWeight: '900' }, confirmationNote: { ...type.caption, padding: space.md, borderRadius: radius.md, backgroundColor: color.surfaceMuted }, confirmationActions: { flexDirection: 'row', gap: space.sm },
});
