...
운영 함수 주소는 `https://chpsoncuxjpgugowrydb.supabase.co/functions/v1/assistant`다. Gemini 전환 코드를 2026-07-28 배포했고 `/health`, CORS, 키 미설정 오류 계약을 확인했다. 실제 AI 왕복은 `GEMINI_API_KEY` 등록 후 검증한다.
